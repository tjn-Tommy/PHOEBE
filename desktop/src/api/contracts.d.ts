...
export type AckCode = "accepted" | "queued" | "replayed" | "unknown_command" | "invalid_payload" | "command_id_conflict" | "maintenance_mode" | "plugin_disabled" | "plugin_api_incompatible" | "missing_role" | "kind_mismatch" | "health_stale" | "device_not_ready" | "calibration_expired" | "device_busy" | "unknown_task" | "invalid_state" | "internal_error";
...
export interface CalibrationAsset {
  asset_id: string;
  binding?: "strict_serial" | "model" | "portable";
  created_at?: string | null;
